        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
          <Link to="/admin/sermons/add">
            <Card className="card-hover cursor-pointer h-full transition-all hover:shadow-md">
              ...
              <CardContent>
                <p className="text-sm text-gray-600">Manage sermon content including descriptions and dates</p>
              </CardContent>
            </Card>
          </Link>
          ...
          <Link to="/admin/events">
            <Card className="card-hover cursor-pointer h-full transition-all hover:shadow-md">
              ...
              <CardContent>
                <p className="text-sm text-gray-600">Manage upcoming events and activities</p>
              </CardContent>
            </Card>
          </Link>
