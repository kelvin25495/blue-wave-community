        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-gray-300 mb-4">
              Bringing young people together through faith, fellowship, and fun.
            </p>
          ...
          <div>
            ...
            <p className="text-gray-300 mb-2">123 Church Street</p>
            <p className="text-gray-300 mb-2">Cityville, ST 12345</p>
            <p className="text-gray-300 mb-2">Email: youth@church.org</p>
